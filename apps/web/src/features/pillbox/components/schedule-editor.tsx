...
import { useAddSchedule, useDeleteSchedule, useUpdateSchedule } from '@/queries';
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-3 pt-0">
        ...
        {showAddForm && (
          <div className="space-y-3 rounded-lg border-2 border-primary/20 border-dashed bg-primary/5 p-4">
            <div className="flex items-center justify-between">
              <p className="font-semibold text-sm">{t('pillbox.newSchedule', 'Nouveau rappel')}</p>
              <Button
                variant="ghost"
                size="icon-sm"
                onClick={() => {
            ...
            <div className="rounded-lg border bg-card p-3">
              {editingId === schedule.id ? (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span
                    className={cn(
                      'inline-flex shrink-0 items-center rounded-md px-2.5 py-1 font-semibold text-xs',
                  ...
                  {/* Time */}
                  <span className="font-medium text-sm tabular-nums">{schedule.intakeTime}</span>
