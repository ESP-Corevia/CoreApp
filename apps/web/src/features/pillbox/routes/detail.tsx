...
import { useAdminDeleteMedication, useAdminUpdateMedication, usePillboxDetail } from '@/queries';
    ...
    <div className="mx-auto max-w-3xl space-y-6 p-6">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-3">
            ...
            <Badge
              variant="outline"
              className={cn(
                'shrink-0 rounded-full px-3 py-0.5 font-medium text-xs',
                medication.isActive
          ...
          {medication.medicationForm && (
            <p className="mt-0.5 text-muted-foreground text-sm">{medication.medicationForm}</p>
          )}
        </div>
      </div>
      ...
      {med.patientName && (
        <Card className="border-primary/20 bg-primary/5">
          <CardContent className="flex items-center gap-3 p-4">
            ...
            <div className="min-w-0 flex-1">
              <p className="font-semibold text-sm">{med.patientName}</p>
              {med.patientEmail && (
                <p className="truncate text-muted-foreground text-xs">{med.patientEmail}</p>
              )}
            </div>
            ...
            <div className="space-y-4">
              ...
              {medication.dosageLabel && (
                <div>
                  ...
                  <p className="mt-1 font-medium text-sm">{medication.dosageLabel}</p>
                </div>
              )}
      ...
      <Card className="border-destructive/20">
        <CardContent className="flex items-center justify-between p-4">
          <div>
            <p className="font-medium text-sm">{t('pillbox.dangerZone', 'Zone de danger')}</p>
            <p className="text-muted-foreground text-xs">
