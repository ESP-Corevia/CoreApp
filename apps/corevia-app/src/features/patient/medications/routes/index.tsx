...
export default function PatientMedications() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="font-bold text-2xl">{t('patient.medications.title')}</h1>
      ...
      {debouncedSearch.length < 2 ? (
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-muted-foreground text-sm">{t('patient.medications.search')}</p>
        </div>
      ) : searchLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="font-medium">{t('patient.medications.empty')}</p>
