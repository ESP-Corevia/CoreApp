  ...
  (
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        // biome-ignore lint/suspicious/noDocumentCookie: pass
  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            'sticky top-0 z-30 hidden h-svh w-[--sidebar-width] shrink-0 transition-[width,margin] duration-200 ease-linear md:flex',
